<%-- 
    Document   : anmeldung
    Created on : 05.09.2019, 23:27:39
    Author     : Surattana
--%>
    ...
    <body>
        ...
        <div class="container-fluid text-center bg-grey centered">
            <div class="signup-form login " >
                <form action="anmeldungErfolg.jsp" method="post">
                    <div class="container">
                        ...
                        <div class="row">  
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-xs-3"><input type="text" class="form-control" name="vorname" placeholder="Vorname" required="required"></div>
                                    <div class="col-xs-3"><input type="text" class="form-control" name="nachname" placeholder="Nachname" required="required"></div>
                                </div>        	
                            </div>
                            <div class="col-sm-2">
                     ...
                     <div class="container">
                         <div class="row">  
                             ...
                             <div class="form-group">
                                 <div class="row">
                                     <div class="col-xs-6">
                                         <input type="password" class="form-control" name="passwort1" placeholder="Passwort bestätigen" required="required">
                                     </div>
                                 </div>
                             </div>  
                             <div class="col-sm-2">
        ...
        <div class="footer">
            <footer class="container-fluid text-center">
                <a href="anmeldungErfolg.jsp" title="To Top">
