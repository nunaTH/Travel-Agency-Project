...
<html>
    ...
    <body>
        <%
            ...
            try {
                ...
                sql = "SELECT * FROM  BsUser where vorname='" + nname.toString() + "' ";
        ...
        <div>
            ...
            <div class="container-fluid text-center bg-grey centered">
                ...
                <div class="container"> 
                    <center><a href="buchungen.jsp"><h2>klick hier zu BS Reiseveranstalter FLY2...</h2></a></center>
                </div>
    ...
    <div class="footer">
        <footer class="container-fluid text-center">
            <a href="buchungen.jsp" title="To Top">
