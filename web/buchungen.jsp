    ...
    <body>
        <%
            ...
            try {
                ...
                String sql2 = "SELECT TOP 10 * FROM  Buchungen WHERE b_id like '%" + keyword + "%' "
                        + " ORDER BY b_id ASC";
                System.out.println(sql2);
                ResultSet rec = s.executeQuery(sql2);
                String sql3 = "SELECT TOP 10 * FROM  Buchungen WHERE p_id like '%" + passagiere + "%' "
                        + " ORDER BY b_id ASC";
            ...
            <div class="jumbotron text-left">
                ...
                <div class="container">                  
                    <div class="col-sm-4">
                        ...
                        Datenbank zeigen (1-10)oder nach der Suchen....
                    </div>
                </div>
            </div>
